...
C_SOURCES = $(wildcard kernel/*.c kernel/system/gui/*.c lib/libc/math/*.c kernel/system/debug/*.c kernel/drivers/*.c lib/libc/string/*.c lib/libc/stdio/*.c kernel/system/memory/*.c kernel/system/interrupts/*.c kernel/system/pit/*.c)
